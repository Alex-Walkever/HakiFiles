...
class HakifilesApi {
  ...
  static Future<dynamic> httpGet(String path) async {
    try {
      final Response<dynamic> resp = await _dio.get(path);
      return resp.data;
  ...
  static Future<dynamic> httpPut(
    ...
    try {
      final Response<dynamic> resp = await _dio.put(path, data: data);
      return resp.data;
    } on DioException catch (e) {
      throw ('Error at get: ${e.message}');
    }
  ...
  static Future<dynamic> httpPost(
    ...
    try {
      final Response<dynamic> resp = await _dio.post(path, data: data);
      return resp.data;
    } on DioException catch (e) {
