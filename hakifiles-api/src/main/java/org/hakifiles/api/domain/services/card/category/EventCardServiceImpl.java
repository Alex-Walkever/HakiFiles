...
import org.hakifiles.api.domain.repositories.card.category.event.EventCardRepository;
...
public class EventCardServiceImpl implements EventCardService {
    ...
    @Override
    public List<EventCard> getEventsCardsByFilter(Map<String, String> params) {
